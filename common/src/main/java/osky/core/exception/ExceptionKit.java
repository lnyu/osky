...
public class ExceptionKit {
    ...
    public static void throwException(int code) {
        throw new UncheckedException(code);
    }

    public static UncheckedException wrapper(Throwable throwable) {
        if (throwable instanceof UncheckedException) {
            return (UncheckedException) throwable;
        } else {
    ...
    public static void throwException(int code, String message) {
        throw new UncheckedException(code, message);
    }
